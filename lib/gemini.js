...
- Per il campo "steps": non riassumere né accorpare in un'unica voce azioni distinte che la fonte presenta come passaggi separati (es. non unire il passaggio 3 e il passaggio 4 in uno solo) — ogni azione/istruzione realmente presente nella fonte deve comparire nell'elenco, senza perdita di dettaglio. Se invece un singolo passaggio della fonte raggruppa già più azioni chiaramente distinte (es. "Preriscalda il forno, imburra la teglia e mescola gli ingredienti secchi" tutto in un unico paragrafo numerato), puoi spezzettarlo in più voci separate per chiarezza — non sei vincolato a rispecchiare esattamente il numero di passaggi della fonte, solo a non perderne il contenuto.
