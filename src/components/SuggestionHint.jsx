    ...
    return (
      <div
        ...
        style={{
          ...
          background:th.appPillBg, border:`1px dashed ${th.appFieldBorder}`, borderRadius:10, cursor:"pointer",
        }}
      >
  ...
  return (
    <div
      ...
      style={{
        ...
        background:th.appPillBg, border:`1px dashed ${th.appFieldBorder}`, borderRadius:10,
