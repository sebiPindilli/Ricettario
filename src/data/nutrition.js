...
export const NUTRITION_DB = [
  ...
  { cat:"Latticini e uova", id:"taleggio", name:"Taleggio", kcal:315, carb:0.9, sug:0.9, prot:19.0, fat:26.2, sat:17.03, fib:0, salt:2.18, defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — sodio reale dalla fonte; grassi saturi genuinamente assenti dalla pagina CREA (verificato direttamente: la fonte riporta solo i lipidi totali, senza scomposizione), stimati al 65% dei grassi totali per analogia con formaggi simili" },
  { cat:"Latticini e uova", id:"caciocavallo", name:"Caciocavallo", kcal:431, carb:2.3, sug:2.3, prot:35.7, fat:31.1, sat:20.22, fib:0, salt:2.4, defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — sodio reale dalla fonte; grassi saturi genuinamente assenti dalla pagina CREA (verificato direttamente), stimati al 65% dei grassi totali per analogia con formaggi simili" },
  { cat:"Latticini e uova", id:"scamorza", name:"Scamorza", kcal:334, carb:1.0, sug:1.0, prot:25.0, fat:25.6, sat:16.64, fib:0, salt:1.2, defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — grassi saturi e sodio genuinamente assenti dalla pagina CREA (verificato direttamente), stimati (grassi saturi al 65% dei grassi totali, sodio per analogia con formaggi simili)" },
  { cat:"Latticini e uova", id:"stracchino", name:"Stracchino", kcal:300, carb:0, sug:0, prot:18.5, fat:25.1, sat:16.32, fib:0, salt:1.0, synonyms:["crescenza stracchino"], defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — grassi saturi e sodio genuinamente assenti dalla pagina CREA (verificato direttamente), stimati (grassi saturi al 65% dei grassi totali, sodio per analogia con formaggi simili)" },
  { cat:"Latticini e uova", id:"robiola", name:"Robiola", kcal:338, carb:2.3, sug:2.3, prot:20.0, fat:27.7, sat:18.01, fib:0, salt:0.9, defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — grassi saturi e sodio genuinamente assenti dalla pagina CREA (verificato direttamente), stimati (grassi saturi al 65% dei grassi totali, sodio per analogia con formaggi simili)" },
  { cat:"Latticini e uova", id:"crescenza", name:"Crescenza", kcal:281, carb:1.9, sug:1.9, prot:16.1, fat:23.3, sat:15.15, fib:0, salt:0.88, defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — sodio reale dalla fonte; grassi saturi genuinamente assenti dalla pagina CREA (verificato direttamente), stimati al 65% dei grassi totali per analogia con formaggi simili" },
  ...
  { cat:"Cioccolato, cacao e dolci", id:"marzapane", name:"Marzapane", kcal:429, carb:57.0, sug:36.25, prot:4.2, fat:17.0, sat:3.9, fib:4.8, salt:0.02, defaultCategories:["altro"], source:"USDA FoodData Central per kcal/macro (valori con variabilità significativa tra fonti); zuccheri e fibre da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Nuts, almond paste\" (nessuna voce \"marzipan\" in SR Legacy, la pasta di mandorle ha composizione equivalente); sodio ancora stimato, non trovato" },
  ...
  { cat:"Varie", id:"alloro", name:"Alloro, foglie essiccate", kcal:313, carb:74.97, sug:0, prot:7.61, fat:8.36, sat:2.28, fib:26.3, salt:0.06, synonyms:["alloro","foglie di alloro"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, bay leaf\" — zuccheri genuinamente non disponibili nemmeno in questo dataset, lasciati a 0 come dato mancante dichiarato anziché stimati" },
  ...
  { cat:"Cucina mediorientale/nordafricana", id:"cardamomo", name:"Cardamomo macinato", kcal:311, carb:68.47, sug:0, prot:10.76, fat:6.7, sat:0.68, fib:28.0, salt:0.045, synonyms:["cardamomo"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, cardamom\" — zuccheri genuinamente non disponibili nemmeno in questo dataset, lasciati a 0 come dato mancante dichiarato" },
  ...
  { cat:"Cucina indiana", id:"fieno_greco", name:"Semi di fieno greco", kcal:323, carb:58.35, sug:0, prot:23.0, fat:6.41, sat:1.46, fib:24.6, salt:0.1675, synonyms:["fieno greco","fenugreek"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, fenugreek seed\" — zuccheri genuinamente non disponibili nemmeno in questo dataset, lasciati a 0 come dato mancante dichiarato" },
