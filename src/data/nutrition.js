...
// (capita soprattutto per grassi saturi/sodio su alcuni formaggi e spezie),
// il campo è null — MAI 0 e MAI un numero stimato/calcolato al posto del
// dato mancante: 0 significa "la fonte riporta zero", null significa "la
// fonte non lo dice". Chi consuma questi campi (buildFoodNameIndex,
// computeRecipeNutrition, macroLine) tratta null come "non disponibile",
// mai come zero silenzioso nella UI.
//
...
export const NUTRITION_DB = [
  ...
  { cat:"Farine, cereali e derivati", id:"farina_segale", name:"Farina di segale", kcal:342, carb:67.8, sug:0.1, prot:11.7, fat:2.0, sat:0, fib:11.3, salt:0.005, synonyms:["farina di segale"], defaultCategories:["cereali"], source:"CREA (alimentinutrizione.it); sodio da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Rye flour, medium\"" },
  ...
  { cat:"Latticini e uova", id:"taleggio", name:"Taleggio", kcal:315, carb:0.9, sug:0.9, prot:19.0, fat:26.2, sat:null, fib:0, salt:2.18, defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — grassi saturi non disponibili: verificata direttamente la pagina CREA, riporta solo i lipidi totali senza scomposizione in acidi grassi" },
  { cat:"Latticini e uova", id:"caciocavallo", name:"Caciocavallo", kcal:431, carb:2.3, sug:2.3, prot:35.7, fat:31.1, sat:null, fib:0, salt:2.4, defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — grassi saturi non disponibili: verificata direttamente la pagina CREA, riporta solo i lipidi totali senza scomposizione in acidi grassi" },
  { cat:"Latticini e uova", id:"scamorza", name:"Scamorza", kcal:334, carb:1.0, sug:1.0, prot:25.0, fat:25.6, sat:null, fib:0, salt:null, defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — grassi saturi e sodio non disponibili: verificata direttamente la pagina CREA, non riporta né scomposizione dei grassi né minerali per questa voce" },
  { cat:"Latticini e uova", id:"stracchino", name:"Stracchino", kcal:300, carb:0, sug:0, prot:18.5, fat:25.1, sat:null, fib:0, salt:null, synonyms:["crescenza stracchino"], defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — grassi saturi e sodio non disponibili: verificata direttamente la pagina CREA, non riporta né scomposizione dei grassi né minerali per questa voce" },
  { cat:"Latticini e uova", id:"robiola", name:"Robiola", kcal:338, carb:2.3, sug:2.3, prot:20.0, fat:27.7, sat:null, fib:0, salt:null, defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — grassi saturi e sodio non disponibili: verificata direttamente la pagina CREA, non riporta né scomposizione dei grassi né minerali per questa voce" },
  { cat:"Latticini e uova", id:"crescenza", name:"Crescenza", kcal:281, carb:1.9, sug:1.9, prot:16.1, fat:23.3, sat:null, fib:0, salt:0.88, defaultCategories:["latticini"], source:"CREA (alimentinutrizione.it) — grassi saturi non disponibili: verificata direttamente la pagina CREA, riporta solo i lipidi totali senza scomposizione in acidi grassi" },
  ...
  { cat:"Pesce", id:"polpo", name:"Polpo", kcal:57, carb:1.4, sug:1.4, prot:10.6, fat:1.0, sat:0.42, fib:0, salt:0.58, synonyms:["polipo"], defaultCategories:["proteine"], source:"CREA (alimentinutrizione.it); sodio da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Mollusks, octopus, common, raw\"" },
  ...
  { cat:"Pesce", id:"orata", name:"Orata, filetti", kcal:121, carb:1.0, sug:1.0, prot:20.7, fat:3.8, sat:1.11, fib:0, salt:null, synonyms:["orata"], defaultCategories:["proteine"], source:"CREA (alimentinutrizione.it) — sodio non disponibile, non riportato dalla fonte" },
  ...
  { cat:"Pesce", id:"baccala", name:"Baccalà, secco", kcal:131, carb:0, sug:0, prot:29.0, fat:1.7, sat:0, fib:0, salt:17.57, synonyms:["baccalà"], defaultCategories:["proteine"], source:"CREA (alimentinutrizione.it) per kcal/macro; sodio da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Fish, cod, Atlantic, dried and salted\" (prodotto sotto sale non dissalato, CREA non lo riporta) — valore reale del dataset, non più una stima" },
  ...
  { cat:"Legumi", id:"fave_secche", name:"Fave, secche", kcal:331, carb:52.8, sug:4.5, prot:21.3, fat:2.1, sat:0.45, fib:14.7, salt:0.03, synonyms:["fave"], defaultCategories:["legumi"], source:"CREA (alimentinutrizione.it); sodio da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Broadbeans (fava beans), mature seeds, raw\"" },
  { cat:"Legumi", id:"lupini", name:"Lupini, ammollati", kcal:119, carb:7.1, sug:0.5, prot:16.4, fat:2.4, sat:0, fib:2.8, salt:0.01, synonyms:["lupini in salamoia"], defaultCategories:["legumi"], source:"CREA (alimentinutrizione.it); sodio da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Lupins, mature seeds, cooked, boiled, without salt\"" },
  ...
  { cat:"Verdure e ortaggi", id:"verza", name:"Cavolo verza, cruda", kcal:29, carb:3.8, sug:3.8, prot:2.0, fat:0.1, sat:0, fib:2.9, salt:0.07, defaultCategories:["ortofrutta"], source:"CREA (alimentinutrizione.it); sodio da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Cabbage, savoy, raw\"" },
  ...
  { cat:"Verdure e ortaggi", id:"topinambur", name:"Topinambur, cotto, bollito", kcal:52, carb:10.6, sug:0, prot:1.6, fat:0.1, sat:0, fib:2.7, salt:0.01, defaultCategories:["ortofrutta"], source:"CREA (alimentinutrizione.it); sodio da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Jerusalem-artichokes, raw\" (nessuna voce per il prodotto cotto, usato il crudo come proxy: il sodio non cambia molto con la sola bollitura senza sale)" },
  ...
  { cat:"Verdure e ortaggi", id:"cavolo_nero", name:"Cavolo nero", kcal:35, carb:4.4, sug:0.99, prot:2.9, fat:1.5, sat:0.178, fib:4.1, salt:0.06, synonyms:["cavolo toscano","kale"], defaultCategories:["ortofrutta"], source:"USDA FoodData Central; zuccheri e grassi saturi da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Kale, raw\" (nessuna voce specifica per la varietà toscana/lacinato in SR Legacy, usata la voce generica kale come proxy più vicino)" },
  { cat:"Verdure e ortaggi", id:"scalogno", name:"Scalogno", kcal:72, carb:16.8, sug:7.87, prot:2.5, fat:0.1, sat:0.017, fib:3.2, salt:0.03, defaultCategories:["ortofrutta"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Shallots, raw\"" },
  ...
  { cat:"Cioccolato, cacao e dolci", id:"cioccolato_bianco", name:"Cioccolato bianco", kcal:539, carb:57.5, sug:59.0, prot:5.0, fat:35.0, sat:19.0, fib:0, salt:0.50, defaultCategories:["cacao"], source:"USDA FoodData Central; zuccheri da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Candies, white chocolate\"" },
  { cat:"Cioccolato, cacao e dolci", id:"marzapane", name:"Marzapane", kcal:429, carb:57.0, sug:36.25, prot:4.2, fat:17.0, sat:3.9, fib:4.8, salt:null, defaultCategories:["altro"], source:"USDA FoodData Central per kcal/macro (valori con variabilità significativa tra fonti); zuccheri e fibre da USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Nuts, almond paste\" (nessuna voce \"marzipan\" in SR Legacy, la pasta di mandorle ha composizione equivalente); sodio non disponibile, non trovato in nessuna fonte consultata" },
  ...
  { cat:"Varie", id:"origano", name:"Origano essiccato", kcal:265, carb:68.92, sug:4.09, prot:9.0, fat:4.28, sat:1.551, fib:42.0, salt:0.06, synonyms:["origano"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, oregano, dried\"" },
  { cat:"Varie", id:"maggiorana", name:"Maggiorana essiccata", kcal:271, carb:60.60, sug:4.09, prot:12.70, fat:7.04, sat:0.529, fib:40.3, salt:0.19, synonyms:["maggiorana"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, marjoram, dried\"" },
  { cat:"Varie", id:"alloro", name:"Alloro, foglie essiccate", kcal:313, carb:74.97, sug:null, prot:7.61, fat:8.36, sat:2.28, fib:26.3, salt:0.06, synonyms:["alloro","foglie di alloro"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, bay leaf\" — zuccheri non disponibili, assenti anche da questo dataset" },
  { cat:"Varie", id:"noce_moscata", name:"Noce moscata macinata", kcal:525, carb:49.29, sug:2.99, prot:5.84, fat:36.31, sat:25.9, fib:20.8, salt:0.04, synonyms:["noce moscata"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, nutmeg, ground\"" },
  { cat:"Varie", id:"chiodi_di_garofano", name:"Chiodi di garofano macinati", kcal:274, carb:65.53, sug:2.38, prot:5.97, fat:13.0, sat:3.952, fib:33.9, salt:0.69, synonyms:["chiodi di garofano"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, cloves, ground\"" },
  { cat:"Varie", id:"erba_cipollina", name:"Erba cipollina fresca", kcal:30, carb:4.35, sug:1.85, prot:3.27, fat:0.73, sat:0.146, fib:4.7, salt:0.01, synonyms:["erba cipollina"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Chives, raw\"" },
  ...
  { cat:"Cucina americana", id:"sciroppo_acero", name:"Sciroppo d'acero", kcal:260, carb:67.04, sug:67.04, prot:0.04, fat:0.06, sat:0, fib:0, salt:0.03, synonyms:["sciroppo d'acero","maple syrup"], defaultCategories:["base"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Syrups, maple\"" },
  ...
  { cat:"Cucina americana", id:"mirtilli_rossi", name:"Mirtilli rossi (cranberries)", kcal:46, carb:11.97, sug:4.27, prot:0.46, fat:0.13, sat:0.008, fib:3.6, salt:0.005, synonyms:["cranberries","mirtilli rossi"], defaultCategories:["ortofrutta"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Cranberries, raw\"" },
  { cat:"Cucina americana", id:"noci_pecan", name:"Noci pecan", kcal:691, carb:13.86, sug:3.97, prot:9.17, fat:71.97, sat:6.18, fib:9.6, salt:0, synonyms:["pecan","noci pecan"], defaultCategories:["grassi"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Nuts, pecans\"" },
  ...
  { cat:"Cucina americana", id:"bacon", name:"Bacon, cotto", kcal:548, carb:1.35, sug:0, prot:35.73, fat:43.27, sat:14.187, fib:0, salt:5.48, synonyms:["bacon"], defaultCategories:["proteine"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Pork, cured, bacon, cooked, baked\"" },
  { cat:"Cucina americana", id:"cream_cheese", name:"Formaggio cremoso spalmabile (cream cheese)", kcal:350, carb:5.52, sug:3.76, prot:6.15, fat:34.44, sat:20.213, fib:0, salt:0.79, synonyms:["cream cheese","philadelphia"], defaultCategories:["latticini"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Cheese, cream\"" },
  ...
  { cat:"Cucina americana", id:"graham_cracker", name:"Graham cracker", kcal:430, carb:77.66, sug:24.85, prot:6.69, fat:10.6, sat:1.633, fib:3.4, salt:1.29, synonyms:["graham cracker"], defaultCategories:["altro"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Cookies, graham crackers, plain or honey (includes cinnamon)\"" },
  { cat:"Cucina americana", id:"popcorn", name:"Popcorn, al naturale", kcal:387, carb:77.78, sug:0.87, prot:12.94, fat:4.54, sat:0.637, fib:14.5, salt:0.02, synonyms:["popcorn"], defaultCategories:["cereali"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Snacks, popcorn, air-popped\"" },
  { cat:"Cucina americana", id:"panna_half", name:"Panna leggera (half and half)", kcal:123, carb:4.73, sug:null, prot:3.13, fat:10.39, sat:7.0, fib:0, salt:null, synonyms:["half and half"], defaultCategories:["latticini"], source:"USDA FoodData Central — zuccheri e sodio non disponibili, non riportati dalla fonte" },
  ...
  { cat:"Cucina sudamericana/messicana", id:"jalapeno", name:"Jalapeño, fresco", kcal:29, carb:6.5, sug:4.12, prot:0.91, fat:0.37, sat:0.092, fib:2.8, salt:0.01, synonyms:["jalapeno","jalapeño"], defaultCategories:["ortofrutta"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Peppers, jalapeno, raw\"" },
  ...
  { cat:"Cucina sudamericana/messicana", id:"lime", name:"Lime", kcal:30, carb:10.54, sug:1.69, prot:0.7, fat:0.2, sat:0.022, fib:2.8, salt:0.005, defaultCategories:["ortofrutta"], defaultEquivalences:{pz:70}, source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Limes, raw\"" },
  ...
  { cat:"Cucina sudamericana/messicana", id:"cumino", name:"Cumino, semi essiccati", kcal:375, carb:44.24, sug:2.25, prot:17.81, fat:22.27, sat:1.535, fib:10.5, salt:0.42, synonyms:["cumino"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, cumin seed\"" },
  { cat:"Cucina sudamericana/messicana", id:"paprika", name:"Paprika essiccata", kcal:282, carb:53.99, sug:10.34, prot:14.14, fat:12.89, sat:2.14, fib:34.9, salt:0.17, synonyms:["paprika","paprika affumicata","paprika dolce"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, paprika\"" },
  { cat:"Cucina sudamericana/messicana", id:"tortilla_mais", name:"Tortilla di mais", kcal:218, carb:44.64, sug:0.88, prot:5.7, fat:2.85, sat:0.453, fib:6.3, salt:0.11, synonyms:["tortilla"], defaultCategories:["cereali"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Tortillas, ready-to-bake or -fry, corn\"" },
  ...
  { cat:"Cucina sudamericana/messicana", id:"papaya", name:"Papaya", kcal:43, carb:10.82, sug:7.82, prot:0.47, fat:0.26, sat:0.081, fib:1.7, salt:0.02, defaultCategories:["ortofrutta"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Papayas, raw\"" },
  ...
  { cat:"Cucina sudamericana/messicana", id:"platano", name:"Platano (banana da cottura)", kcal:122, carb:31.89, sug:17.51, prot:1.3, fat:0.35, sat:0, fib:1.7, salt:0.01, synonyms:["platano","plantain","banana da cottura"], defaultCategories:["ortofrutta"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Plantains, yellow, raw\"; valori della varietà matura" },
  { cat:"Cucina sudamericana/messicana", id:"yuca", name:"Yuca (manioca)", kcal:160, carb:38.06, sug:1.7, prot:1.36, fat:0.28, sat:0.074, fib:1.8, salt:0.035, synonyms:["manioca","cassava"], defaultCategories:["cereali"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Cassava, raw\"" },
  ...
  { cat:"Cucina asiatica", id:"salsa_soia", name:"Salsa di soia", kcal:53, carb:4.93, sug:0.4, prot:8.14, fat:0.57, sat:0.073, fib:0.8, salt:13.73, synonyms:["salsa di soia","soy sauce","shoyu"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Soy sauce made from soy and wheat (shoyu)\"" },
  ...
  { cat:"Cucina asiatica", id:"salsa_pesce", name:"Salsa di pesce (nam pla)", kcal:35, carb:3.64, sug:null, prot:5.06, fat:null, sat:null, fib:null, salt:19.63, synonyms:["salsa di pesce","nam pla","fish sauce","nuoc mam"], defaultCategories:["spezie"], source:"USDA FoodData Central (via recipal.com) — la fonte riportava solo \"carboidrati netti\" (3.64g, qui in carb) senza scomporre fibra/zuccheri: entrambi non disponibili; grassi dichiarati dalla fonte come trascurabili ma senza cifra, anch'essi non disponibili" },
  ...
  { cat:"Cucina asiatica", id:"salsa_hoisin", name:"Salsa hoisin", kcal:220, carb:44.08, sug:27.26, prot:3.31, fat:3.39, sat:0.568, fib:2.8, salt:4.04, synonyms:["hoisin"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Sauce, hoisin, ready-to-serve\"" },
  { cat:"Cucina asiatica", id:"salsa_ostrica", name:"Salsa di ostriche", kcal:51, carb:10.92, sug:0, prot:1.35, fat:0.25, sat:0.043, fib:0.3, salt:6.83, synonyms:["salsa di ostriche","oyster sauce"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Sauce, oyster, ready-to-serve\"" },
  { cat:"Cucina asiatica", id:"pasta_curry_rossa", name:"Pasta di curry rossa", kcal:135, carb:14.7, sug:7.4, prot:3.7, fat:6.9, sat:null, fib:null, salt:4.12, synonyms:["curry rosso","red curry paste","pasta di curry"], defaultCategories:["spezie"], source:"Dati commerciali aggregati (myfooddata.com, nutrifox.com, recipal.com) — valori molto variabili tra marche (100-150 kcal/100g dichiarati); usata una voce dettagliata scalata da porzione da 15g; grassi saturi e fibra non disponibili, non riportati dalla fonte" },
  ...
  { cat:"Cucina asiatica", id:"bok_choy", name:"Bok choy (cavolo cinese)", kcal:13, carb:2.2, sug:1.2, prot:1.5, fat:0.2, sat:0, fib:1.0, salt:0.16, synonyms:["bok choy","pak choi","cavolo cinese"], defaultCategories:["ortofrutta"], source:"USDA FoodData Central (via nutritionvalue.org/ketogenic.com), voce \"cabbage, raw, chinese (bok choy)\"" },
  ...
  { cat:"Cucina asiatica", id:"edamame", name:"Edamame (fagioli di soia freschi)", kcal:121, carb:8.91, sug:2.18, prot:11.91, fat:5.2, sat:0.62, fib:5.2, salt:0.015, synonyms:["edamame","fagioli di soia"], defaultCategories:["legumi"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Edamame, frozen, prepared\"" },
  ...
  { cat:"Cucina asiatica", id:"shiitake", name:"Funghi shiitake, freschi", kcal:34, carb:6.8, sug:2.4, prot:2.24, fat:0.49, sat:null, fib:2.5, salt:0.0225, synonyms:["shiitake"], defaultCategories:["ortofrutta"], source:"USDA FoodData Central (via recipal.com/foodstruct.com) — grassi saturi non disponibili, la fonte non li scompone dal totale" },
  { cat:"Cucina asiatica", id:"nori", name:"Alga nori, essiccata", kcal:35, carb:5.1, sug:0.5, prot:5.8, fat:0.3, sat:null, fib:5.6, salt:1.44, synonyms:["nori","alga nori"], defaultCategories:["altro"], source:"USDA FoodData Central (via foodstruct.com per kcal/macro; fibre e sodio da voce myfooddata.com \"dried seaweed\", più concentrata della voce \"raw laver\" per il minor contenuto d'acqua) — grassi saturi non disponibili, la fonte non li scompone dal totale" },
  { cat:"Cucina asiatica", id:"tempeh", name:"Tempeh", kcal:209, carb:5.5, sug:0.9, prot:20.3, fat:10.8, sat:2.5, fib:4.0, salt:0.02, synonyms:["tempeh"], defaultCategories:["proteine"], source:"Matvaretabellen (tabella di composizione degli alimenti norvegese, Mattilsynet), voce \"tempeh, soy bean product\"" },
  ...
  // dichiarato, dichiarato voce per voce ──
  { cat:"Cucina asiatica", id:"riso_jasmine", name:"Riso jasmine, crudo", kcal:355, carb:79.6, sug:0.2, prot:7.5, fat:0.7, sat:0.1, fib:0, salt:0.003, synonyms:["riso jasmine","riso gelsomino"], defaultCategories:["cereali"], source:"Matvaretabellen (tabella di composizione degli alimenti norvegese, Mattilsynet), voce \"rice, jasmin, uncooked\"" },
  { cat:"Cucina asiatica", id:"riso_basmati", name:"Riso basmati, crudo", kcal:354, carb:76.8, sug:0.2, prot:9.2, fat:1.1, sat:0.2, fib:0.5, salt:0, synonyms:["riso basmati"], defaultCategories:["cereali"], source:"Matvaretabellen (tabella di composizione degli alimenti norvegese, Mattilsynet), voce \"rice, basmati, uncooked\" — confermato incrociando con nutritiontable.com (valori entro 2g di scarto sui macro)" },
  { cat:"Cucina asiatica", id:"noodles_riso", name:"Noodles di riso, secchi", kcal:361, carb:82.2, sug:0.6, prot:6.0, fat:0.6, sat:0.2, fib:2.0, salt:0.46, synonyms:["noodles di riso","spaghetti di riso","rice noodles"], defaultCategories:["cereali"], source:"Matvaretabellen (tabella di composizione degli alimenti norvegese, Mattilsynet), voce \"noodles, rice, uncooked\"" },
  { cat:"Cucina asiatica", id:"noodles_udon", name:"Noodles udon, cotti", kcal:104, carb:21.6, sug:0, prot:2.8, fat:0.4, sat:0, fib:0.8, salt:0.3, synonyms:["udon","noodles udon"], defaultCategories:["cereali"], source:"USDA FoodData Central (via recipal.com) — a differenza degli altri cereali del database (riportati crudi/secchi), questa voce è sui noodles già cotti: le fonti sul prodotto secco erano troppo discordanti tra loro (104-400 kcal/100g, alcune chiaramente riferite per errore al prodotto cotto) per scegliere un valore affidabile; il sodio non include la bustina di condimento delle confezioni di udon istantaneo, non parte dell'ingrediente \"noodles\"" },
  { cat:"Cucina asiatica", id:"zenzero", name:"Zenzero, radice fresca", kcal:80, carb:17.77, sug:1.7, prot:1.82, fat:0.75, sat:0.203, fib:2.0, salt:0.03, synonyms:["zenzero","ginger"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Ginger root, raw\" — Matvaretabellen (tabella norvegese) riporta invece 50 kcal per la stessa voce: discrepanza reale tra le due fonti ufficiali, non risolvibile con certezza; usato SR Legacy perché coincide con la ricerca USDA originaria" },
  { cat:"Cucina asiatica", id:"semi_sesamo", name:"Semi di sesamo, essiccati", kcal:573, carb:23.45, sug:0.3, prot:17.73, fat:49.67, sat:6.957, fib:11.8, salt:0.0275, synonyms:["sesamo","semi di sesamo","sesame seeds"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Seeds, sesame seeds, whole, dried\"" },
  { cat:"Cucina asiatica", id:"curcuma_fresca", name:"Curcuma, radice fresca", kcal:40, carb:7.0, sug:null, prot:0, fat:1.0, sat:null, fib:2.0, salt:0.24, synonyms:["curcuma fresca","turmeric"], defaultCategories:["spezie"], source:"USDA FoodData Central (via recipal.com) — proteine dichiarate a 0 dalla fonte (valore reale riportato, insolitamente basso per una radice fresca ma non un dato mancante); zuccheri e grassi saturi non disponibili, la fonte non li scompone dal totale" },
  { cat:"Cucina asiatica", id:"wasabi", name:"Wasabi, radice fresca", kcal:109, carb:23.0, sug:null, prot:4.8, fat:0.63, sat:null, fib:7.8, salt:0.0425, synonyms:["wasabi"], defaultCategories:["spezie"], source:"USDA FoodData Central (via fatsecret.com/myfooddata.com/foodstruct.com) — zuccheri e grassi saturi non disponibili, la fonte non li scompone dal totale" },
  ...
  { cat:"Cucina mediorientale/nordafricana", id:"tahini", name:"Tahina (crema di sesamo)", kcal:626, carb:0.8, sug:0.4, prot:18.5, fat:58.9, sat:8.4, fib:9.0, salt:0.05, synonyms:["tahini","tahina","crema di sesamo"], defaultCategories:["spezie"], source:"Matvaretabellen (tabella di composizione degli alimenti norvegese, Mattilsynet), voce \"sesame paste, tahini\"" },
  { cat:"Cucina mediorientale/nordafricana", id:"sumac", name:"Sumac macinato", kcal:345, carb:48.1, sug:7.0, prot:13.3, fat:14.4, sat:null, fib:33.8, salt:0.0825, synonyms:["sommacco","sumac"], defaultCategories:["spezie"], source:"USDA FoodData Central (via myfooddata.com) — usata la voce \"senza sale aggiunto\" (33mg sodio/100g): altre fonti riportavano 2840-4200mg per varianti commerciali salate, scartate perché non rappresentative della spezia pura; grassi saturi non disponibili, la fonte non li scompone dal totale" },
  { cat:"Cucina mediorientale/nordafricana", id:"lenticchie_rosse", name:"Lenticchie rosse decorticate, secche", kcal:352, carb:63.35, sug:2.03, prot:24.63, fat:1.06, sat:0.154, fib:10.7, salt:0.015, synonyms:["lenticchie rosse","red lentils"], defaultCategories:["legumi"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Lentils, raw\"" },
  { cat:"Cucina mediorientale/nordafricana", id:"cardamomo", name:"Cardamomo macinato", kcal:311, carb:68.47, sug:null, prot:10.76, fat:6.7, sat:0.68, fib:28.0, salt:0.045, synonyms:["cardamomo"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, cardamom\" — zuccheri non disponibili, assenti anche da questo dataset" },
  ...
  { cat:"Cucina mediorientale/nordafricana", id:"bulgur", name:"Bulgur, secco", kcal:342, carb:75.87, sug:0.41, prot:12.29, fat:1.33, sat:0.232, fib:12.5, salt:0.04, synonyms:["bulgur"], defaultCategories:["cereali"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Bulgur, dry\"" },
  { cat:"Cucina mediorientale/nordafricana", id:"pane_pita", name:"Pane pita, bianco", kcal:275, carb:55.7, sug:1.3, prot:9.1, fat:1.2, sat:0.166, fib:2.2, salt:1.34, synonyms:["pita","pane pita"], defaultCategories:["cereali"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Bread, pita, white, enriched\"" },
  { cat:"Cucina mediorientale/nordafricana", id:"labneh", name:"Labneh (yogurt colato)", kcal:150, carb:4.0, sug:null, prot:6.0, fat:10.0, sat:null, fib:0, salt:null, synonyms:["labneh"], defaultCategories:["latticini"], source:"Dati commerciali aggregati (calorique.io/healthline.com) — valori variabili per marca/percentuale di grassi; zuccheri, grassi saturi e sodio non disponibili con un valore univoco (la fonte dava solo un intervallo di sodio, 200-300mg, senza un dato singolo affidabile)" },
  ...
  { cat:"Cucina indiana", id:"curcuma_polvere", name:"Curcuma in polvere", kcal:291, carb:44.4, sug:3.2, prot:9.7, fat:3.3, sat:1.8, fib:23.0, salt:0.07, synonyms:["curcuma","curcuma in polvere","turmeric"], defaultCategories:["spezie"], source:"Matvaretabellen (tabella di composizione degli alimenti norvegese, Mattilsynet), voce \"turmeric, ground\". Voce distinta dalla curcuma fresca già nel database (radice essiccata e macinata, molto più concentrata)" },
  { cat:"Cucina indiana", id:"semi_coriandolo", name:"Semi di coriandolo, essiccati", kcal:346, carb:13.1, sug:0, prot:12.4, fat:17.8, sat:1.0, fib:42.0, salt:0.09, synonyms:["semi di coriandolo","coriander seed"], defaultCategories:["spezie"], source:"Matvaretabellen (tabella di composizione degli alimenti norvegese, Mattilsynet), voce \"coriander seeds\". Voce distinta dal coriandolo fresco già nel database (semi essiccati, non foglie)" },
  { cat:"Cucina indiana", id:"semi_senape", name:"Semi di senape, macinati", kcal:518, carb:15.9, sug:6.8, prot:26.1, fat:36.2, sat:2.0, fib:12.0, salt:0.03, synonyms:["semi di senape","mustard seed"], defaultCategories:["spezie"], source:"Matvaretabellen (tabella di composizione degli alimenti norvegese, Mattilsynet), voce \"mustard seeds\"" },
  { cat:"Cucina indiana", id:"fieno_greco", name:"Semi di fieno greco", kcal:323, carb:58.35, sug:null, prot:23.0, fat:6.41, sat:1.46, fib:24.6, salt:0.1675, synonyms:["fieno greco","fenugreek"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, fenugreek seed\" — zuccheri non disponibili, assenti anche da questo dataset" },
  { cat:"Cucina indiana", id:"foglie_curry", name:"Foglie di curry, fresche", kcal:108, carb:18.7, sug:null, prot:6.1, fat:1.0, sat:null, fib:6.4, salt:0, synonyms:["foglie di curry","curry leaves"], defaultCategories:["spezie"], source:"Dati commerciali aggregati (nutritionix.com/nutrition-and-you.com) — una fonte alternativa riportava 97 kcal/100g, differenza probabilmente dovuta al contenuto di umidità della foglia analizzata; zuccheri e grassi saturi non disponibili, non riportati da nessuna fonte consultata" },
  { cat:"Cucina indiana", id:"peperoncino_polvere", name:"Peperoncino in polvere (cayenna)", kcal:318, carb:56.63, sug:10.34, prot:12.01, fat:17.27, sat:3.26, fib:27.2, salt:0.075, synonyms:["peperoncino in polvere","cayenna","cayenne pepper","chili powder"], defaultCategories:["spezie"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Spices, pepper, red or cayenne\". Voce distinta dal peperoncino fresco già nel database (spezia essiccata e macinata, molto più concentrata)" },

  // ── Cucina indiana, lotto 20: legumi, cereali e latticini — chiude la
  // cucina indiana e la Fase B (cucine internazionali). USDA FoodData
  // Central; riso basmati già presente dal lotto 16; stimato dove
  // dichiarato, dichiarato voce per voce ──
  { cat:"Cucina indiana", id:"ghee", name:"Ghee (burro chiarificato)", kcal:876, carb:0, sug:0, prot:0.28, fat:99.48, sat:61.9, fib:0, salt:0.005, synonyms:["ghee","burro chiarificato"], defaultCategories:["grassi"], source:"USDA FoodData Central (via myfooddata.com)" },
  { cat:"Cucina indiana", id:"paneer", name:"Paneer", kcal:226, carb:1.0, sug:0, prot:15.0, fat:18.0, sat:11.0, fib:0, salt:0.46, synonyms:["paneer"], defaultCategories:["latticini"], source:"USDA FoodData Central (via nutritionadvance.com/myfooddata.com) — fonti riportavano un intervallo di calorie piuttosto ampio (220-318 kcal/100g secondo la marca/preparazione); usato il valore calcolabile dai macronutrienti dichiarati, coerente con l'estremo basso dell'intervallo (paneer non salato/fatto in casa, a differenza di versioni confezionate più saline)" },
  { cat:"Cucina indiana", id:"farina_ceci", name:"Farina di ceci (besan)", kcal:387, carb:57.82, sug:10.85, prot:22.39, fat:6.69, sat:0.693, fib:10.8, salt:0.16, synonyms:["besan","farina di ceci"], defaultCategories:["legumi"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Chickpea flour (besan)\"" },
  { cat:"Cucina indiana", id:"dal_piselli_piccioni", name:"Dal di piselli piccioni, secco (toor dal)", kcal:343, carb:62.78, sug:null, prot:21.7, fat:1.49, sat:0.33, fib:15.0, salt:0.04, synonyms:["toor dal","dal","arhar dal","piselli piccioni"], defaultCategories:["legumi"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Pigeon peas (red gram), mature seeds, raw\" — zuccheri non disponibili, assenti anche da questo dataset" },
  { cat:"Cucina indiana", id:"naan", name:"Pane naan", kcal:291, carb:50.43, sug:3.55, prot:9.62, fat:5.65, sat:1.393, fib:2.2, salt:1.16, synonyms:["naan"], defaultCategories:["cereali"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Bread, naan, plain, commercially prepared, refrigerated\"" },
  { cat:"Cucina indiana", id:"latte_cocco", name:"Latte di cocco in scatola", kcal:197, carb:2.81, sug:0, prot:2.02, fat:21.33, sat:19.0, fib:2.2, salt:0.0325, synonyms:["latte di cocco","coconut milk"], defaultCategories:["grassi"], source:"USDA FoodData Central (via foodstruct.com/myfooddata.com) — zuccheri dichiarati a 0 da una delle fonti consultate, non ulteriormente scomposti da USDA" },
  { cat:"Cucina indiana", id:"fagioli_rossi", name:"Fagioli rossi, secchi (rajma)", kcal:333, carb:60.01, sug:2.23, prot:23.58, fat:0.83, sat:0.12, fib:24.9, salt:0.06, synonyms:["rajma","fagioli rossi","red kidney beans"], defaultCategories:["legumi"], source:"USDA SR Legacy (dataset locale, scaricato in blocco da fdc.nal.usda.gov), voce \"Beans, kidney, all types, mature seeds, raw\"" },
];
