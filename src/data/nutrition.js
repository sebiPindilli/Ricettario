...
export const NUTRITION_DB = [
  ...
  { cat:"Cucina asiatica", id:"zenzero", name:"Zenzero, radice fresca", kcal:50, carb:8.1, sug:1.7, prot:1.8, fat:0.8, sat:0.2, fib:2.0, salt:0.03, synonyms:["zenzero","ginger"], defaultCategories:["spezie"], source:"Matvaretabellen (tabella di composizione degli alimenti norvegese, Mattilsynet), voce \"ginger, root, raw\"" },
  ...
  { cat:"Cucina indiana", id:"farina_ceci", name:"Farina di ceci (besan)", kcal:387, carb:57.82, sug:10.0, prot:22.39, fat:6.69, sat:0, fib:10.0, salt:0.16, synonyms:["besan","farina di ceci"], defaultCategories:["legumi"], source:"USDA FoodData Central (via foodstruct.com/myfooddata.com) — grassi saturi stimati trascurabili (fonte non li scomponeva)" },
  { cat:"Cucina indiana", id:"dal_piselli_piccioni", name:"Dal di piselli piccioni, secco (toor dal)", kcal:343, carb:54.0, sug:1.8, prot:21.7, fat:1.5, sat:0, fib:15.0, salt:0.02, synonyms:["toor dal","dal","arhar dal","piselli piccioni"], defaultCategories:["legumi"], source:"USDA FoodData Central (via fittr.com) — fonti discordanti su calorie/proteine (una citava 240 kcal/16g proteine, probabilmente per il seme cotto anziché crudo secco); usato il valore per il seme crudo secco (343 kcal, coerente con lenticchie/ceci secchi già nel database), carboidrati e grassi non dichiarati dalla fonte per questa voce, stimati per analogia con le lenticchie secche già nel database (stesso rapporto carboidrati/kcal)" },
  { cat:"Cucina indiana", id:"naan", name:"Pane naan", kcal:291, carb:50.43, sug:3.0, prot:9.62, fat:5.65, sat:0, fib:2.0, salt:1.16, synonyms:["naan"], defaultCategories:["cereali"], source:"USDA FoodData Central (via foodstruct.com/recipal.com) — grassi saturi stimati per analogia con altri pani arricchiti di grassi (fonte non li scomponeva)" },
  ...
  { cat:"Cucina indiana", id:"fagioli_rossi", name:"Fagioli rossi, secchi (rajma)", kcal:333, carb:60.01, sug:0, prot:23.58, fat:0.83, sat:0, fib:24.9, salt:0.0125, synonyms:["rajma","fagioli rossi","red kidney beans"], defaultCategories:["legumi"], source:"USDA FoodData Central (via foodstruct.com/myfooddata.com) — zuccheri non riportati dalla fonte (dato dichiarato non disponibile), stimati trascurabili per analogia con altri legumi secchi crudi già nel database" },
];
